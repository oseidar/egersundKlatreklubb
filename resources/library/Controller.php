...
class Controller {
 ...
 public  function init(){
     ...
     /*
      * Her bygger vi menyen. Alle nettsider må ha en meny så da bygger vi den her...
      */
     
     
     
     /*
      * Under lager vi widgetsene.. 
      */
 ...
 public function setMainRender($mainRender) {
...
public function registerModules(){
   ...
   //print_r($this->user);
    ...
    $mc->setTplFile("modules/menu/view/top.tpl");
    
    $this->router->params['topMenu'] = $mc->render();
